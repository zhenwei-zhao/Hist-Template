...
% 作者姓名
\newcommand{\HISTAuthor}{作者姓名}

% 学位类别（如：农业硕士、工学硕士等）
\newcommand{\HISTDegreeCategory}{学位类别}

% 专业名称
\newcommand{\HISTField}{专业名称}

% 研究方向（学硕）
\newcommand{\ResearchDirection}{研究方向（学硕）}

% 指导教师（含职称）
\newcommand{\HISTSupervisor}{XXX \ 教授}

% 行业导师  （含职称）（如无可填“无”）（专业学位）
\newcommand{\HISTIndustrySupervisor}{XXX \ 副教授}

% 中文封面日期（推荐使用中文数字）
\newcommand{\HISTDateCN}{二〇二六年五月}
